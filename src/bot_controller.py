...
class BotController:
    ...
    def toggle_autoplay(self):
        ...
        self.gui.update_status(f"Autoplay: { 'Enabled' if self.autoplay_enabled else 'Disabled'}")
        ...
        if self.autoplay_enabled:
            ...
            if fen:
                ...
                if best_move:
                    ...
                    print(f"fen: {fen}, move: {best_move}")
                else:
    ...
    def run_bot_loop(self):
        ...
        # self.lichess.open_lichess() # This is now handled by main.py
        while self.is_running:
            self.update_settings()

            if not self.lichess.isTurn():
                continue
